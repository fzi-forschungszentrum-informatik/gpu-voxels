...
#define InstantiateNTree(branching_factor, level_count, INNER_NODE, LEAF_NODE) \
    ...
    template voxel_count NTree<branching_factor, level_count, INNER_NODE, LEAF_NODE>::intersect_sparse<true, false, gpu_voxels::ProbabilisticVoxel>(gpu_voxels::voxelmap::TemplateVoxelMap<gpu_voxels::ProbabilisticVoxel>&, gpu_voxels::ProbabilisticVoxel*, const uint32_t, gpu_voxels::Vector3ui);\
    template voxel_count NTree<branching_factor, level_count, INNER_NODE, LEAF_NODE>::intersect_sparse<false, false, gpu_voxels::ProbabilisticVoxel>(gpu_voxels::voxelmap::TemplateVoxelMap<gpu_voxels::ProbabilisticVoxel>&, gpu_voxels::ProbabilisticVoxel*, const uint32_t, gpu_voxels::Vector3ui);\
    template voxel_count NTree<branching_factor, level_count, INNER_NODE, LEAF_NODE>::intersect_sparse<true, false, gpu_voxels::BitVoxel<BIT_VECTOR_LENGTH> >(gpu_voxels::voxelmap::TemplateVoxelMap<gpu_voxels::BitVoxel<BIT_VECTOR_LENGTH> >&, gpu_voxels::BitVoxel<BIT_VECTOR_LENGTH>*, const uint32_t, gpu_voxels::Vector3ui);\
    template voxel_count NTree<branching_factor, level_count, INNER_NODE, LEAF_NODE>::intersect_sparse<false, false, gpu_voxels::BitVoxel<BIT_VECTOR_LENGTH> >(gpu_voxels::voxelmap::TemplateVoxelMap<gpu_voxels::BitVoxel<BIT_VECTOR_LENGTH> >&, gpu_voxels::BitVoxel<BIT_VECTOR_LENGTH>*, const uint32_t, gpu_voxels::Vector3ui);\
    template voxel_count NTree<branching_factor, level_count, INNER_NODE, LEAF_NODE>::intersect_sparse<true, true, gpu_voxels::BitVoxel<BIT_VECTOR_LENGTH> >(gpu_voxels::voxelmap::TemplateVoxelMap<gpu_voxels::BitVoxel<BIT_VECTOR_LENGTH> >&, gpu_voxels::BitVoxel<BIT_VECTOR_LENGTH>*, const uint32_t, gpu_voxels::Vector3ui);\
    template voxel_count NTree<branching_factor, level_count, INNER_NODE, LEAF_NODE>::intersect_morton<true, false, gpu_voxels::BitVoxel<BIT_VECTOR_LENGTH> >(gpu_voxels::voxellist::TemplateVoxelList<gpu_voxels::BitVoxel<BIT_VECTOR_LENGTH>, OctreeVoxelID >&, gpu_voxels::BitVoxel<BIT_VECTOR_LENGTH>*, const uint32_t);\
