 ...
 */
//----------------------------------------------------------------------/*
#ifndef GPU_VOXELS_VOXELMAP_BIT_VOXEL_HPP_INCLUDED
#define GPU_VOXELS_VOXELMAP_BIT_VOXEL_HPP_INCLUDED

#include "BitVoxel.h"
#include <gpu_voxels/helpers/BitVector.hpp>
...
template<std::size_t length>
__host__ __device__
void BitVoxel<length>::insert(const uint32_t voxel_type)
{
  m_bit_vector.setBit(voxel_type);
}
