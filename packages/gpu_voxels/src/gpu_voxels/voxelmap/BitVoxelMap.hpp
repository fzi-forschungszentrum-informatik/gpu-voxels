                                                                     ...
                                                                     BitVector<length>* colliding_meanings_)
{
  ...
  {
    computeLinearLoad(cloud_sizes[sub_cloud], &this->m_blocks_sensor_operations,
                             &this->m_threads_sensor_operations);

    kernelInsertMetaPointCloudSelfCollCheck<<<this->m_blocks_sensor_operations, this->m_threads_sensor_operations>>>(
